        ...
        <div class="hidden md:flex flex-col">
            ...
            <div class="px-24 h-14 w-screen flex flex-row items-center justify-between border border-[#CCCCCC] bg-white z-50">
                <div class="flex flex-row items-center text-lg">
                    ...
                    <button class="mr-4 px-4 py-1.5 rounded-sm hover:bg-gray-100 duration-200 focus:ring-4 focus:outline-none focus:ring-gray-100">
                        <p>Features</p>
                    </button>
                    <button id="tools-menu-full-dropdown-button" data-target="tools-menu-full-dropdown" aria-expanded="false" @click="expandMenus" class="mr-4 flex flex-row items-start px-4 py-1.5 rounded-sm hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 duration-200">
                        <p class="mr-1.5">Toolbox</p>
                        <i class="__expandicon bi bi-chevron-down text-sm mt-1.5 transition-transform duration-200"></i>
                    </button>
                </div>
                <div class="flex flex-row items-center">
                    <button @click="expandMenus" data-target="category-menu-full-dropdown" class="flex flex-row items-start px-4 py-1.5 rounded-sm hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 duration-200">
        ...
        <div class="w-screen flex flex-wrap items-center justify-between py-4 px-6 bg-base-navy md:hidden">
            ...
            <div class="hidden w-full py-4" id="navbar-hamburger">
                ...
                <ul class="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Feature</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white">Feature</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Toolbox</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Category</a>
                    </li>
                </ul>
            </div>
        </div>
